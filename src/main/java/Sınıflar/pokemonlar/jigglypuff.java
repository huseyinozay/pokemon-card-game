...
public class jigglypuff extends Pokemon{
    ...
    public jigglypuff(int pokemonID, String pokemonAdi, String pokemonTipi) {
        super(pokemonID, pokemonAdi, pokemonTipi);
    }

    public jigglypuff(int hasarPuani, int pokemonID, String pokemonAdi, String pokemonTipi) {
        super(pokemonID, pokemonAdi, pokemonTipi);

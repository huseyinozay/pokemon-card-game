...
public class butterfree extends Pokemon{
    ...
    public butterfree(int pokemonID, String pokemonAdi, String pokemonTipi) {
        super(pokemonID, pokemonAdi, pokemonTipi);
    }

    public butterfree(int hasarPuani, int pokemonID, String pokemonAdi, String pokemonTipi) {
        super(pokemonID, pokemonAdi, pokemonTipi);

...
public class charmander extends Pokemon{
    ...
    public charmander(int pokemonID, String pokemonAdi, String pokemonTipi) {
        super(pokemonID, pokemonAdi, pokemonTipi);
    }

    public charmander(int hasarPuani, int pokemonID, String pokemonAdi, String pokemonTipi) {
        super(pokemonID, pokemonAdi, pokemonTipi);
